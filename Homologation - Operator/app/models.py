...
class ProcessTable(db.Model):
    ...
    date_time = db.Column(db.DateTime, nullable=False) # during submit
    vehicle_name = db.Column(db.String(20), nullable=False) # from front end when start inspection
    vehicle_part = db.Column(db.String(50)) # from front-end with scan 
    vehicle_part_id = db.Column(db.Integer) # from front-end with scan 
    part_code_name = db.Column(db.String(100)) # from front-end with scan 
    part_code_requirement = db.Column(db.String(50)) # from test table (expected value)
    ...
    approve_status = db.Column(db.String(50), nullable=False, default='Pending') # set pending for all when submit
